...
require_once($CFG->dirroot . "/blocks/rate/backup/moodle2/restore_rate_stepslib.php");

/**
 * Class restore_rate_block_task
 */
class restore_rate_block_task extends restore_block_task {
    /**
    ...
    protected function define_my_steps() {
        $this->add_step(new restore_rate_block_structure_step("rate_structure",
            "rate.xml"));
    }
